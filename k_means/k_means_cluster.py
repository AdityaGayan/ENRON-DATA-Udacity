...
scaler = MinMaxScaler()
new_salaries = scaler.fit_transform(salaries)
new_exercised_stock_options = scaler.fit_transform(exercised_stock_options)
...
exercised = [item["exercised_stock_options"] for key,item in data_dict.items() if item["exercised_stock_options"] != "NaN"]
print min(exercised)
print max(exercised)
